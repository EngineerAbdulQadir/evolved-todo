...
export function TaskFilters({
  ...
  return (
    <div className="relative h-full" ref={dropdownRef}>
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div className="absolute left-0 z-50 mt-0 w-80 bg-black border border-white border-t-0 shadow-2xl rounded-none animate-in fade-in slide-in-from-top-1 duration-100">
          <div className="p-0">
