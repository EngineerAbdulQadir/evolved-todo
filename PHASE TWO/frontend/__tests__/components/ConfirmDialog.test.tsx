...
describe('ConfirmDialog Component', () => {
  ...
  describe('Variants', () => {
    it('renders with danger variant styling', () => {
      ...
      const dialogPanel = container.querySelector('.border-red-900\\/50');
    ...
    it('renders with warning variant styling', () => {
      ...
      const dialogPanel = container.querySelector('.border-amber-900\\/50');
      expect(dialogPanel).toBeInTheDocument();
    });
    ...
    it('renders with info variant styling', () => {
      ...
      const dialogPanel = container.querySelector('.border-cyan-900\\/50');
      expect(dialogPanel).toBeInTheDocument();
    });
