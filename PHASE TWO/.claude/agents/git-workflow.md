...
name: git-workflow
description: |
  Use this agent when preparing to commit code changes, before creating pull requests, or when reviewing git history and branch management. This agent should be invoked proactively before any commit operation to ensure version control best practices are followed.
  ...
  **Example 4 - Proactive Invocation During Development:**
  ...
  ```
model: sonnet
skills: git-workflow, documentation
---
