...
export function SortDropdown({ value, onChange }: SortDropdownProps) {
  ...
  return (
    <div className="relative h-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-0 w-64 bg-black border border-white border-t-0 shadow-xl rounded-none animate-in fade-in slide-in-from-top-1 duration-100">
          <div className="py-0">
