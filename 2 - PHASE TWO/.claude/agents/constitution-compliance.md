...
description: |
  Use this agent when you need to validate that code, architecture, or features comply with the project constitution before implementation begins. This agent should be invoked proactively before any code changes are made, during code reviews, and before merging any pull requests.
...
model: sonnet
skills: spec-to-code, feature-implementation, quality-check
---
...
- After completing significant reviews, document patterns and compliance decisions for future reference
