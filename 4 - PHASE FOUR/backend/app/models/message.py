...
class MessageRole(str, Enum):
    ...
    USER = "USER"
    ASSISTANT = "ASSISTANT"
    TOOL = "TOOL"  # For tool execution results in conversation history
...
class Message(SQLModel, table=True):
    ...
    Attributes:
        ...
        role: Who sent the message ("user" | "assistant" | "tool")
    ...
    Business Rules:
        ...
        - role must be "user", "assistant", or "tool" (for tool execution results)
